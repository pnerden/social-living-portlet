...
create index IX_789766AC on LSPSL_EventEntry (companyId, endDate);
...
create index IX_BA43997C on LSPSL_EventEntry (companyId, groupId, endDate);
create index IX_EF3B8DCF on LSPSL_EventEntry (groupId);
create index IX_3E0B9B2A on LSPSL_EventEntry (groupId, endDate);
