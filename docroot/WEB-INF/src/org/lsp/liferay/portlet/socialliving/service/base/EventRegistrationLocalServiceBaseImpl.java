...
/**
 * The base implementation of the event registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.lsp.liferay.portlet.socialliving.service.impl.EventRegistrationLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class EventRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EventRegistrationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.lsp.liferay.portlet.socialliving.service.EventRegistrationLocalServiceUtil} to access the event registration local service.
	 */
	...
	public EventRegistration addEventRegistration(
		EventRegistration eventRegistration) throws SystemException {
		eventRegistration.setNew(true);

		return eventRegistrationPersistence.update(eventRegistration, false);
	}
	 ...
	 */
	public EventRegistration createEventRegistration(long eventRegistrationId) {
		return eventRegistrationPersistence.create(eventRegistrationId);
	}
	...
	public EventRegistration deleteEventRegistration(long eventRegistrationId)
		throws PortalException, SystemException {
		return eventRegistrationPersistence.remove(eventRegistrationId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public EventRegistration deleteEventRegistration(
		EventRegistration eventRegistration) throws SystemException {
		return eventRegistrationPersistence.remove(eventRegistration);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(EventRegistration.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return eventRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return eventRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public EventRegistration fetchEventRegistration(long eventRegistrationId)
		throws SystemException {
		return eventRegistrationPersistence.fetchByPrimaryKey(eventRegistrationId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EventRegistration getEventRegistration(long eventRegistrationId)
		throws PortalException, SystemException {
		return eventRegistrationPersistence.findByPrimaryKey(eventRegistrationId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return eventRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EventRegistration> getEventRegistrations(int start, int end)
		throws SystemException {
		return eventRegistrationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getEventRegistrationsCount() throws SystemException {
		return eventRegistrationPersistence.countAll();
	}
	...
	public EventRegistration updateEventRegistration(
		EventRegistration eventRegistration) throws SystemException {
		return updateEventRegistration(eventRegistration, true);
	}
	...
	public EventRegistration updateEventRegistration(
		...
		return eventRegistrationPersistence.update(eventRegistration, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("org.lsp.liferay.portlet.socialliving.model.EventRegistration",
			eventRegistrationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = eventRegistrationPersistence.getDataSource();
	...
	private EventRegistrationLocalServiceClpInvoker _clpInvoker = new EventRegistrationLocalServiceClpInvoker();
}